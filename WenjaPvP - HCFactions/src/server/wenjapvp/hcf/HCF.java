...
import server.wenjapvp.hcf.command.GoppleCommand;
import server.wenjapvp.hcf.command.LogoutCommand;
import server.wenjapvp.hcf.command.PvpTimerCommand;
...
import server.wenjapvp.hcf.deathban.DeathbanListener;
import server.wenjapvp.hcf.deathban.DeathbanManager;
import server.wenjapvp.hcf.deathban.FlatFileDeathbanManager;
import server.wenjapvp.hcf.deathban.StaffReviveCommand;
import server.wenjapvp.hcf.deathban.lives.LivesExecutor;
...
import server.wenjapvp.hcf.faction.type.GlowstoneMountainFaction;
...
public class HCF extends JavaPlugin
{
	...
	@Getter public static TimerManager timerManager;
...
//				{
//					if (player.hasPermission("alert"))
//					{
//						player.sendMessage(ChatColor.RED + "Starting to save core's data..");
//						Bukkit.getServer().savePlayers();
//						Bukkit.getServer().getWorld("world").save();
//						Bukkit.getServer().getWorld("world_nether").save();
//						Bukkit.getServer().getWorld("world_the_end").save();
//						saveData();
//						player.sendMessage("");
//						player.sendMessage(ChatColor.GREEN + "Core's Data Has Saved Successfully..");
//					}
//				}
//			}
//		}.runTaskTimerAsynchronously(getPlugin(), 2400L, 2400L);
	}
