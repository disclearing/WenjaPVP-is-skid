package server.wenjapvp.hcf.faction.claim;
...
import server.wenjapvp.hcf.visualise.VisualBlock;
import server.wenjapvp.hcf.visualise.VisualType;
    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        if (action == Action.LEFT_CLICK_BLOCK || action == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (plugin.getClaimHandler().canClaimHere(player, blockLocation)) {
                ...
                player.sendMessage(ChatColor.GREEN + "Seleccion " + ChatColor.YELLOW + selectionId + ChatColor.GREEN + " en: " + ChatColor.GOLD + '(' + ChatColor.YELLOW
                ...
                if (claimSelection.hasBothPositionsSet()) {
                    ...
                    player.sendMessage(ChatColor.AQUA + "Este claim cuesta: " + (selectionPrice > playerFaction.getBalance() ? ChatColor.RED : ChatColor.GREEN) + EconomyManager.ECONOMY_SYMBOL
                            + selectionPrice + ChatColor.AQUA + ". Espacio actual: (" + ChatColor.WHITE + claim.getWidth() + ", " + claim.getLength() + ChatColor.AQUA + "), " + ChatColor.WHITE
                            + claim.getArea() + ChatColor.AQUA + " bloques.");
                }
