package server.wenjapvp.hcf.config;
...
public class ConfigurationService {
    ...
    public static int WARZONE_RADIUS = 400;
    public static String DONATE_URL = "tiendapvp.freshcraft.es";
    ...
    public static int MAX_MEMBERS_PER_FACTION = 15;
    ...
    public static long DEFAULT_DEATHBAN_DURATION = TimeUnit.HOURS.toMillis(2L);
    ...
    public static int CONQUEST_REQUIRED_WIN_POINTS = 200;
