...
import server.wenjapvp.hcf.faction.argument.*;
import server.wenjapvp.hcf.faction.argument.staff.*;
...
//        addArgument(new FactionLivesDepositArgument(plugin));
//        addArgument(new FactionReviveArgument(plugin));
//        addArgument(new FactionSetLivesArgument(plugin));
    }
